...
function Right_Sec_2_List_Post_Form() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://optimize-agency.vercel.app/api/blogsapi/Right_Sec_2_List_Post_Form", {
        method: 'POST',
  ...
  return (
    <div className='m-10 px-10 py-10 border border-[#9EFF00] rounded-2xl'>
      <h1 className='text-4xl font-semibold uppercase text-center border-b pb-6'>Right Sec 2: List Post Form</h1>
...
export default Right_Sec_2_List_Post_Form