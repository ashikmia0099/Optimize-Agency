...
function Right_Sec_2_First_Image_Post_Form() {
  ...
  return (
    <div className='m-10 px-10 py-10 border border-[#9EFF00] rounded-2xl'>
      <h1 className='text-4xl font-semibold uppercase text-center border-b pb-6'>Right Sec 2 : First Image Post Form</h1>
...
export default Right_Sec_2_First_Image_Post_Form