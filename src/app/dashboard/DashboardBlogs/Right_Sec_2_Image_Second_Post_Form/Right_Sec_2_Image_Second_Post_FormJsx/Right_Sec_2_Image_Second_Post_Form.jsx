...
function Right_Sec_2_Image_Second_Post_Form() {
    ...
    const handleFormSubmit = async (e) => {
      ...
      try {
        const response = await fetch("https://optimize-agency.vercel.app/api/blogsapi/Right_Sec_2_Image_Second_Post_api", {
          method: 'POST',
  ...
  return (
    ...
    <h1 className='text-4xl font-semibold uppercase text-center border-b pb-6'>Right Sec 2 : Second Image Post Form</h1>
...
export default Right_Sec_2_Image_Second_Post_Form