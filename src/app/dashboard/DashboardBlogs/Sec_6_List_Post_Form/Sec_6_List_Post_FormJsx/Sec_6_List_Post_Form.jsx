...
function Sec_6_List_Post_Form() {
  ...
  return (
    <div className='m-10 px-10 py-10 border border-[#9EFF00] rounded-2xl'>
      <h1 className='text-4xl font-semibold uppercase text-center border-b pb-6'>Sec 6 : List Post Form</h1>
...
export default Sec_6_List_Post_Form