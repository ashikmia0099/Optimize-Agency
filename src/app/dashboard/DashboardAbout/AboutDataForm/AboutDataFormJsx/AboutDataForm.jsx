...
function AboutDataForm() {


    
        const handleAboutDataForm = async (e) =>{
            e.preventDefault();
            ...
            try {
                ...
                if (res.insertedId) {
                    Swal.fire({
                        position: 'top-end',
                        icon: 'success',
                        title: 'About Data Post Successfully Added!',
    ...
    return (
        <div className='m-10 px-10 py-10 border border-[#9EFF00] rounded-2xl'>
            <h1 className='text-4xl font-semibold uppercase text-center border-b pb-6'>Post About Data </h1>
            <form onSubmit={handleAboutDataForm}>
                <fieldset className="fieldset pt-2">
                    ...
                    <legend className="fieldset-legend text-lg font-semibold pt-5">Description <span className=' text-[12px]'>(Max 40-45 word)</span></legend>
