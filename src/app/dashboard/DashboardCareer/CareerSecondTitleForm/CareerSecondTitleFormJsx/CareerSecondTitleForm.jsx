...
function CareerSecondTitleForm() {
    const handleCareerFirstTitleForm = async (e) => {
        ...
        try {
            const response = await fetch("https://optimize-agency.vercel.app/api/careerapi/CareerSecondTitleFormapi", {
                method: 'POST',
            ...
            if (res.insertedId) {
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                    title: 'Career Title Post Successfully Added!',
...
export default CareerSecondTitleForm